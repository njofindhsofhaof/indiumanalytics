...
const COMPANY_NEWS: Article[] = [
  ...
  { title: "Fabrinet (FN) — Investor Relations", description: "Optical manufacturing capacity, customer program updates, and earnings from Fabrinet.", url: "https://investor.fabrinet.com/press-releases", source: { name: "Fabrinet IR" }, publishedAt: new Date(Date.now() - 5 * 3600000).toISOString(), urlToImage: null, tag: "FN" },
  { title: "MACOM Technology (MTSI) — Press Releases", description: "III-V compound semiconductor, analog photonics, and optical networking news from MACOM.", url: "https://ir.macom.com/news-releases/", source: { name: "MACOM IR" }, publishedAt: new Date(Date.now() - 6 * 3600000).toISOString(), urlToImage: null, tag: "MTSI" },
  ...
  { title: "Applied Optoelectronics (AAOI) — Newsroom", description: "400G/800G DWDM transceiver modules for hyperscaler datacenter deployments, revenue guidance, and manufacturing updates.", url: "https://ao-inc.com/about-us/news/", source: { name: "AAOI Newsroom" }, publishedAt: new Date(Date.now() - 11 * 3600000).toISOString(), urlToImage: null, tag: "AAOI" },
  ...
  { title: "Celestica (CLS) — Newsroom", description: "Optical module manufacturing at scale, 800G/1.6T transceiver capacity, and hyperscaler supply chain announcements.", url: "https://corporate.celestica.com/newsroom", source: { name: "Celestica Newsroom" }, publishedAt: new Date(Date.now() - 14 * 3600000).toISOString(), urlToImage: null, tag: "CLS" },
];
